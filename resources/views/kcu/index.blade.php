...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data KCU</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('kcu.create')}}" class="btn btn-warning btn-sm">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table  class="table table-bordered"  width="100%" cellspacing="0" style="border-radius: 10px;">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                        <div class="row">
                                      <a href="{{route('tampilkcu', $data->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                                                  
                                               
                           <form method="POST" action="{{ route('deletekcu', $data->id) }}">
                            @csrf
