...
<div id="myDataTable_filter" class="dataTables_filter">
                                ...
                                <table  class="table table-bordered"  width="100%" cellspacing="0" style="border-radius: 10px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <form action="{{ route('reset-password', ['user' => $dtUser->id]) }}" method="POST">    @csrf
  ...
  @if($dtUser->nama !== 'Admin')
    <a href="{{route('tampiluser', $dtUser->id)}}" data-toggle="tooltip" title='Edit' class="btn"><i class="fas fa-fw fa-edit" style="color:orange;"></i></a>

    <form method="POST" action="{{ route('deleteuser', $dtUser->id) }}">
      @csrf
  ...
  @else
    <!-- Jika nama user adalah 'Admin', tampilkan tombol yang dinonaktifkan -->
    <a href="#" class="btn muted" style="color: gray;" disabled><i class="fas fa-fw fa-edit"></i></a>
    
    <button class="btn muted" style="color: gray;" disabled><i class="fas fa-fw fa-trash"></i></button>
  @endif
</td>
